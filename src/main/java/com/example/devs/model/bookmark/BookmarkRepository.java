...
public interface BookmarkRepository extends JpaRepository<Bookmark, Integer> {
    ...
    // 해당 회원이 북마크한 게시글 찾기
    @Query("select b from Bookmark b where b.user.id = :userId and b.board.id = :boardId")
    Optional<Bookmark> findByUserIdAndBoardId(@Param("userId") Integer userId, @Param("boardId") Integer boardId);
