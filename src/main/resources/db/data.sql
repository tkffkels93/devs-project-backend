...
VALUES
    (1, 1, '이 게시글을 통해 많은 것을 배웠습니다. 설명이 매우 명확하고 구체적이어서 이해하기 쉬웠습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (1, 1, '게시글 덕분에 많은 도움이 되었습니다. 설명이 매우 자세하고 이해하기 쉽게 작성되어 있어 좋았습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (2, 2, '이 게시글의 주제가 매우 흥미롭습니다. 앞으로도 더 많은 정보를 공유해주시기 바랍니다. 다른 사람들이 이 게시글을 보고 많은 것을 배웠으면 좋겠습니다.', 'PUBLISHED', NOW(), NULL, 'Board'),
    (2, 2, '게시글의 내용이 이해하기 쉽지 않았습니다. 일부 설명이 더 필요할 것 같습니다. 특히 특정 기능의 동작 방식에 대해 더 자세히 설명해주시면 좋겠습니다. 감사합니다.', 'HIDE', NOW(), NULL, 'Board'),
    (3, 3, '이 게시글을 통해 많은 것을 배웠습니다. 특히 예제 코드가 큰 도움이 되었습니다. 앞으로도 이런 유용한 정보가 담긴 게시글을 많이 작성해주시길 기대합니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (3, 3, '게시글에 설명된 내용 중 일부가 최신 정보와 다릅니다. 최신 정보를 반영해 업데이트해주시면 더 많은 사람들이 유용하게 사용할 수 있을 것 같습니다. 감사합니다.', 'DELETED', NOW(), NULL, 'Board'),
    (4, 4, '게시글을 통해 많은 정보를 얻었습니다. 특히 실제 예제를 통해 이해할 수 있었던 부분이 좋았습니다. 앞으로도 좋은 정보 많이 공유해주세요. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (4, 4, '내용이 매우 유익했습니다. 특히 마지막 부분의 결론이 인상적이었습니다. 다른 주제에 대해서도 이런 자세한 설명을 기대합니다. 좋은 게시글 감사합니다.', 'PUBLISHED', NOW(), NULL, 'Board'),
    (5, 5, '이 게시글 덕분에 많은 도움이 되었습니다. 설명이 매우 자세하고 이해하기 쉽게 작성되어 있어 좋았습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (5, 5, '게시글의 내용이 상당히 유익했습니다. 특히 각 단계를 따라가며 실습할 수 있어서 좋았습니다. 다른 주제에 대해서도 이런 유용한 게시글을 기대합니다.', 'HIDE', NOW(), NULL, 'Board'),
    (6, 6, '이 게시글을 통해 많은 것을 배웠습니다. 설명이 매우 명확하고 구체적이어서 이해하기 쉬웠습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (6, 6, '내용이 매우 유익했습니다. 특히 마지막 부분의 결론이 인상적이었습니다. 다른 주제에 대해서도 이런 자세한 설명을 기대합니다. 좋은 게시글 감사합니다.', 'DELETED', NOW(), NULL, 'Board'),
    (7, 7, '게시글을 통해 많은 정보를 얻었습니다. 특히 실제 예제를 통해 이해할 수 있었던 부분이 좋았습니다. 앞으로도 좋은 정보 많이 공유해주세요. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (7, 7, '내용이 매우 유익했습니다. 특히 마지막 부분의 결론이 인상적이었습니다. 다른 주제에 대해서도 이런 자세한 설명을 기대합니다. 좋은 게시글 감사합니다.', 'PUBLISHED', NOW(), NULL, 'Board'),
    (8, 8, '이 게시글 덕분에 많은 도움이 되었습니다. 설명이 매우 자세하고 이해하기 쉽게 작성되어 있어 좋았습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (8, 8, '게시글의 내용이 상당히 유익했습니다. 특히 각 단계를 따라가며 실습할 수 있어서 좋았습니다. 다른 주제에 대해서도 이런 유용한 게시글을 기대합니다.', 'HIDE', NOW(), NULL, 'Board'),
    (9, 9, '이 게시글을 통해 많은 것을 배웠습니다. 설명이 매우 명확하고 구체적이어서 이해하기 쉬웠습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (9, 9, '내용이 매우 유익했습니다. 특히 마지막 부분의 결론이 인상적이었습니다. 다른 주제에 대해서도 이런 자세한 설명을 기대합니다. 좋은 게시글 감사합니다.', 'PUBLISHED', NOW(), NULL, 'Board'),
    (10, 10, '게시글 덕분에 많은 도움이 되었습니다. 설명이 매우 자세하고 이해하기 쉽게 작성되어 있어 좋았습니다. 앞으로도 좋은 정보 많이 공유해주시길 바랍니다. 감사합니다!', 'PUBLISHED', NOW(), NULL, 'Board'),
    (10, 10, '게시글의 내용이 상당히 유익했습니다. 특히 각 단계를 따라가며 실습할 수 있어서 좋았습니다. 다른 주제에 대해서도 이런 유용한 게시글을 기대합니다.', 'PUBLISHED', NOW(), NULL, 'Board');
