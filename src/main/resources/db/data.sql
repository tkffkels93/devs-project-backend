...
VALUES (1, 'Board', '첫 번째 게시글', '첫 번째 게시글의 내용입니다.', 100, 'PUBLISHED', NOW(), NULL),
       (2, 'Inquiry', '두 번째 게시글', '두 번째 게시글의 내용입니다.', 50, 'HIDE', NOW(), NULL),
       ...
       (7, 'Board', '일곱 번째 게시글', '일곱 번째 게시글의 내용입니다.', 300, 'HIDE', NOW(), NULL),
       ...
       (1, 'Answer', '열두 번째 게시글', '열두 번째 게시글의 내용입니다.', 40, 'HIDE', NOW(), NULL),
       ...
       (2, 'Board', '열아홉 번째 게시글', '열아홉 번째 게시글의 내용입니다.', 240, 'HIDE', NOW(), NULL),
